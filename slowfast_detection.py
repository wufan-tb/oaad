...
def get_person_bboxes(inp_img, predictor):
    ...
    # print("ROI info:",type(boxes.tensor),type(scores),type(predictions.pred_classes))
    predicted_boxes = boxes[np.logical_and(classes==0, scores>0.5 )].tensor.cpu() # only person
...
label_map, allowed_class_ids = AvaLabeledVideoFramePaths.read_label_map('self_utils/ava_action_list.pbtxt')
...
vide_save_path = 'test_img/video/output.mp4'
